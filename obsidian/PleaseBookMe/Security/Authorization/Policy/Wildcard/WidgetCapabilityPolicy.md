...
This allow-list is explicitly a placeholder for a real capability model, not the finished design — see **[[Security/Authorization/Authorization Engine]]** for how it fits into the wider decision algebra.
