...
-- Phase 12 - Indexes - Auth
-- =====================================================

-- users(username/email/phone), user_passwords(user_id), and
-- api_keys(public_key) are already indexed by their UNIQUE constraints /
-- PRIMARY KEY - not repeated here.
