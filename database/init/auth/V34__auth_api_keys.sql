...
-- Phase 4 (patch) - Auth - API Keys
-- =====================================================

-- Deferred since Phase 2 - api_keys.tenant_id references tenant.tenants,
-- which does not exist until Phase 4. Per AGENTS.md this table is
-- currently unused by the application; created now so the schema is
-- complete, dormant until wired up.
