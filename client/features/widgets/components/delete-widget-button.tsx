...
import { deleteWidget } from "@/features/widgets/services/widget-api";
    ...
    try {
      ...
      setError(
        caught instanceof ApiRequestError
          ? caught.message
          : "Could not delete this widget. Please try again."
      );
    } finally {
      setPending(false);
    }
    ...
    <div className="flex flex-col items-end gap-xs">
      <div className="flex items-center justify-end gap-xs">
        ...
        <button
          ...
          title={confirming ? `Confirm deleting ${name}` : `Delete ${name}`}
          className={cn(
